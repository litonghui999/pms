...
<dl class='bitem'><dt onclick=showHide("items6_1")><b>其他管理</b></dt><dd style='display:none' class='sitem' id=items6_1><ul class='sitemu' id=5>
	<li><a href='modpassword.jsp' target='main'>作业提交</a> </li>
	<li><a href='info.jsp' target='main'>信息反馈</a> </li>
